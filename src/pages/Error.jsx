  ...
  if (error.status === 404) {
    return (
      <div>
        ...
        {/* =-=-=-=-=-=-= Error Page =-=-=-=-=-=-= */}
        <section id="error-page" className="section-padding-70">
          <div className="container">
            {/* Row */}
            <div className="row">
              <div className="col-md-5 col-sm-6 col-xs-12">
                ...
                <div className="error-title">
                  Oops, the page you are looking for does not exit.
                </div>
                <p>
                  Fusce pretium nulla et purus malesuada feugiat sed vel mauris
                  tincidunt vehicula lorem vel hendrerit justo praesent aliquam
                  maximus imperdiet integer sagittis leo
                </p>
              </div>
              <div className="col-md-7 col-sm-6 col-xs-12">
                <img alt="" className="img-responsive" src="images/404.png" />
              </div>
            </div>
            {/* Row End */}
          </div>
                  ...
                  >
                    <div className="row clearfix">
                      ...
                      <div className="form-group col-md-12 col-sm-12 col-xs-12 text-right">
                        {' '}
                        <a className="custom-button light">
                          Submit Request
                        </a>{' '}
                      </div>
                    </div>
